...
describe('AppComponent', () => {
  ...
  beforeEach(async () => {
    youtubeServiceSpy = jasmine.createSpyObj('YoutubeApiService', ['searchVideos']);
    
    await TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, SearchBarComponent, VideoListComponent],
      providers: [
        { provide: YoutubeApiService, useValue: youtubeServiceSpy }
      ]
    }).compileComponents();
  ...
  it('should update searchTerm when searchVideos is called', () => {
    ...
    youtubeServiceSpy.searchVideos.and.returnValue(of({ items: [], nextPageToken: '' }));
  ...
  it('should render video list component', () => {
    const videoList = fixture.debugElement.query(By.directive(VideoListComponent));
